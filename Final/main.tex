...
\input{Parts/SoA} % État de l'art
\input{Parts/Tranche1} % Présentation de la méthode et des résultats
\input{Parts/Tranche2} % Présentation de la méthode et des résultats
